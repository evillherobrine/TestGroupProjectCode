...
class MusicService : MediaBrowserServiceCompat() {
    ...
    internal var mediaSession: MediaSessionCompat
        get() = mediaSessionHandler.mediaSession
        set(_) {}
    ...
    override fun onCreate() {
        ...
        sessionToken = mediaSessionHandler.getSessionToken()
        ...
        ServiceCompat.startForeground(
            ...
            notificationManager.buildNotification(mediaSessionHandler.mediaSession),
    ...
    internal fun triggerNotificationUpdate() {
        ...
        notificationManager.updateNotification(mediaSessionHandler.mediaSession, isCurrentSongFavorite)
    }
